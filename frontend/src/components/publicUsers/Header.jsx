        ...
        <div className="self-stretch flex flex-row items-start justify-start">
          <div className="flex-1 flex flex-row items-end justify-start gap-[23.8px]">
            <div className="flex flex-col items-start justify-end pt-0 px-0 pb-[1.4px]">
              <img
                className="w-10 h-[41px] relative"
                loading="lazy"
                alt=""
                src="/group-37.svg"
              />
            ...
            <button onClick={handleOpen} className="cursor-pointer [border:none] pt-[7.6px] pb-[7.7px] pl-[13px] pr-3 bg-tradewind flex-1 rounded-17xl flex flex-row items-start justify-start gap-[18px]">
              <img
